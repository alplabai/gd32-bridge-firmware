 ...
 * bare-metal, interrupt-driven application in which
 ...
 * those short shared-state claims.  Raw interrupt masking also exists for
 * separate purposes in the bootloader handoff, FMC busy windows and the
 * terminal fault path.
 *
